...
namespace Loupedeck.ClusterControlPlugin
{
    ...
    public class NVtopCommand2 : PluginDynamicCommand
    {
        ...
        protected override void RunCommand(String actionParameter)
        {
            ...
            this.sshCommand = $"ssh -J {this.userName}@{this.serverIp},{this.userName}@{this.hosts[0]} -t {this.userName}@{this.hosts[1]} nvtop";
