namespace Loupedeck.ClusterControlPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ClusterControlPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ClusterControlPlugin.Resources.Resource.txt`.
